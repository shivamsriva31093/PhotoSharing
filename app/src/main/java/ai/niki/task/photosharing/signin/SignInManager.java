...
package ai.niki.task.photosharing.signin;
...
import ai.niki.task.photosharing.utils.RegistrationUtils;
...
public class SignInManager {
    ...
    private void performPostSignInTasks(GoogleSignInAccount acct, GoogleSignInResult result) {
        ...
        firebaseAuthWithGoogle(acct, result);
...
//        AnalyticsHelper.setUserSignedIn(true);
     ...
     * @param result
     */
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct, GoogleSignInResult result) {
        ...
        mFirebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(activity, task -> {
                    if (!task.isSuccessful()) {
                        ...
                        signInListener.onSignInFailed(null);
                        return;
                    }
