...
import ai.niki.task.photosharing.archframework.PresenterImpl;
import ai.niki.task.photosharing.archframework.UpdatableView;
import ai.niki.task.photosharing.navigation.NavigationModel.NavigationItemEnum;
import ai.niki.task.photosharing.navigation.NavigationModel.NavigationQueryEnum;
import ai.niki.task.photosharing.navigation.NavigationModel.NavigationUserActionEnum;
