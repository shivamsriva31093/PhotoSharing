...
import ai.niki.task.photosharing.Config;

import static ai.niki.task.photosharing.utils.LogUtils.LOGD;
import static ai.niki.task.photosharing.utils.LogUtils.LOGE;
import static ai.niki.task.photosharing.utils.LogUtils.LOGI;
import static ai.niki.task.photosharing.utils.LogUtils.LOGV;
import static ai.niki.task.photosharing.utils.LogUtils.LOGW;
...
public class AccountUtils {
    ...
    private static final String PREF_ACTIVE_ACCOUNT_DISPLAY_NAME =
            "pref_active_account_display_name" + Config.CONFERENCE_YEAR_PREF_POSTFIX;
    ...
    private static final String PREF_ACTIVE_ACCOUNT_PHOTO_URL =
            "pref_active_account_photo_url" + Config.CONFERENCE_YEAR_PREF_POSTFIX;

    /**
     * Used for accessing the account id stored in {@link SharedPreferences}.
     */
    private static final String PREF_ACTIVE_ACCOUNT_ID =
            "pref_active_account_id" + Config.CONFERENCE_YEAR_PREF_POSTFIX;
